...
namespace ProjetCSVtoSVG
{
    /// <summary>
    /// 
    /// Classe Dessin : le Chef d'Orchestre des Fichiers (Developpeur B - Blocs 2 et 3).
    /// Contient une List generique d'ElementGraphique (collection generique, cf. Cours 2).
    ...
    public class Dessin
    {
        ...
        // List<ElementGraphique> : tableau dynamique d'objets ElementGraphique
        // Polymorphisme : la liste peut contenir des Cercle, Rectangle, etc.
        // car ils heritent tous de ElementGraphique (cf. Heritage et Polymorphisme)
        // =====================================================================
        ...
        /// </summary>
        public List<ElementGraphique> Elements
        {
            get { return elements; }
        }

        /// <summary>
        /// Constructeur : initialise la collection generique List<ElementGraphique>.
        ...
        public Dessin()
        {
            ...
            elements = new List<ElementGraphique>();
        }

        /// <summary>
        /// Methode d'instance AjouterElement : ajoute un element a la liste avec Add().
        /// (cf. Cours 2 - List<T>.Add())
        /// </summary>
        public void AjouterElement(ElementGraphique element)
        {
        ...
        /// <summary>
        /// Lit un fichier CSV et remplit la List d'elements graphiques.
            ...
            try
            {
                ...
                using (StreamReader lecteur = new StreamReader(cheminFichier))
                {
                    ...
                    while ((ligne = lecteur.ReadLine()) != null)
                    {
                        ...
                        // Le premier champ indique le type d'element
                        ...
                        try
                        {
                            ...
                            {
                                // Creer l'element graphique correspondant
                                ElementGraphique element = CreerElement(champs, type);
                                if (element != null)
                                {
                        ...
                        {
                            // Exception si le nombre de champs est insuffisant
                ...
                // Appliquer les transformations aux elements correspondants
        ...
        /// <summary>
        /// Cree un ElementGraphique a partir des champs CSV.
        /// Utilise int.Parse() et double.Parse() pour convertir les textes en nombres.
        /// Polymorphisme : retourne un objet de type ElementGraphique qui est en fait
        /// une instance d'une classe fille (Cercle, Rectangle, etc.)
        /// </summary>
        private ElementGraphique CreerElement(string[] champs, string type)
        {
            ...
            switch (type)
            {
                ...
                default:
                    Console.WriteLine($"Attention : type d'element inconnu '{type}', ligne ignoree.");
                    return null;
            }
        }

        /// <summary>
        /// Applique les transformations (Translation, Rotation) aux elements correspondants.
        /// Recherche l'element par son idElement dans la liste avec foreach (cf. Cours 2).
        /// </summary>
        private void AppliquerTransformations(List<string[]> lignesTransformations)
        {
            ...
            foreach (string[] champs in lignesTransformations)
            {
                ...
                // Rechercher l'element par son idElement dans la liste
                ElementGraphique element = TrouverElementParId(idElement);
                ...
                try
                {
                    if (type == "Translation")
                    {
                        ...
                        element.AjouterTransformation($"translate({dx},{dy})");
                    }
                    else if (type == "Rotation")
                    {
                        ...
                        element.AjouterTransformation($"rotate({alpha},{x},{y})");
                    }
                }
                catch (FormatException ex)
                {
        ...
        /// <summary>
        /// Recherche un element dans la collection par son idElement.
        /// Parcours avec foreach (cf. Cours 2 - parcourir une collection avec foreach).
        /// </summary>
        private ElementGraphique TrouverElementParId(int idElement)
        {
            // Parcours de la List<ElementGraphique> avec foreach
            foreach (ElementGraphique elem in elements)
            {
                if (elem.IdElement == idElement)
                    return elem;
            }
            return null;
        }
        ...
        /// <summary>
        /// Ecrit le fichier SVG a partir des elements graphiques de la liste.
        /// 1. Trie les elements par leur ordre d'affichage grace a IComparable (cf. Classe Abstraite et Interface).
        /// 2. Ecrit la balise d'ouverture <svg>.
        /// 3. Pour chaque element, appelle GenererBaliseSvg() (polymorphisme, cf. Heritage et Polymorphisme).
        ...
        public void EcrireFichierSVG(string cheminFichier)
        {
            ...
            try
            {
                ...
                // Sort() utilise IComparable<ElementGraphique>.CompareTo() implemente dans ElementGraphique
                ...
                using (StreamWriter ecrivain = new StreamWriter(cheminFichier))
                {
                    ...
                    // Polymorphisme : chaque element appelle SA propre version de GenererBaliseSvg()
                    // (virtual/override, cf. Heritage et Polymorphisme)
                    foreach (ElementGraphique element in elements)
                    {
                        ecrivain.WriteLine(element.GenererBaliseSvg());
                    }
